...
def initialize_mediapipe_solutions():
    try:
        # Attempt to set the resource path for MediaPipe models
        ...
        # Initialize MediaPipe solutions with explicit model paths
        mp_face_mesh = mp.solutions.face_mesh
        mp_pose = mp.solutions.pose

        # Explicitly provide model paths
...
home_title = Label(home_page, text="Welcome to FocusGuard", font=("Arial", 16, "bold"))
...
help_subtitle = Label(help_page, text="How to use FocusGuard:", font=("Arial", 12))
