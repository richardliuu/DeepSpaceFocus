...
# Right eye
RIGHT_EYE_INDICES = [362, 263, 386, 385, 384, 398, 386, 374]  
...
def analyze_upper_body_posture(landmarks):
    try:
        ...
        MAX_SHOULDER_LEVEL = 0.05  
        MAX_VERTICAL_ALIGNMENT = 0.1  
        MAX_HEAD_TILT = 10  
        MAX_NECK_ANGLE = 15 
...
def visualize_upper_body_posture(frame, results):
    ...
    if results.pose_landmarks:
        ...
        landmark_drawing_spec = [
            (mp_pose.PoseLandmark.NOSE, (0, 255, 0), 7),          
            (mp_pose.PoseLandmark.LEFT_SHOULDER, (255, 0, 0), 10),  
            (mp_pose.PoseLandmark.RIGHT_SHOULDER, (0, 0, 255), 10), 
            (mp_pose.PoseLandmark.LEFT_EAR, (255, 255, 0), 5),    
            (mp_pose.PoseLandmark.RIGHT_EAR, (255, 255, 0), 5)   
        ]
